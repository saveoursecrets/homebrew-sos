...
class Sos < Formula
  ...
  if Hardware::CPU.arm?
    ...
    url "https://releases.saveoursecrets.com/beta/cli/0.5.5/macos/aarch64/saveoursecrets.zip"
  else
    sha256 "e155affbf41e5cb71709915b28056b6c2824809f3d134cdfb70193551ead8077"
    url "https://releases.saveoursecrets.com/beta/cli/0.5.5/macos/x86_64/saveoursecrets.zip"
  end
