...
class Sos < Formula
  ...
  if Hardware::CPU.arm?
    ...
    url "https://releases.saveoursecrets.com/beta/cli/macos/0.5.1/aarch64/saveoursecrets.zip"
  else
    sha256 "9e645810255740e185731f5a854855d4eb1ba75cbf3e32732945c4c66dd0ac88"
    url "https://releases.saveoursecrets.com/beta/cli/macos/0.5.1/x86_64/saveoursecrets.zip"
  end
